...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState('collections'); // Homepage default tab: 'collections' | 'feed' | 'history'
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3 border-b border-[#272727] pb-4">
              <button
                ...
                className="bg-[#1f1f1f] hover:bg-[#252525] p-2 rounded-xl border border-[#3f3f3f] text-gray-300 hover:text-white transition-colors"
                title="Back to Collections Grid"
              >
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">{selectedCollection.description || 'Collection playlist'}</p>
              </div>
            </div>

            {/* Video Player + Comment Panel inside Collection */}
            {currentVideo && (
            ...
            <div className="space-y-3 pt-4 border-t border-[#272727]">
              <h2 className="text-sm font-bold text-white">Videos in this collection ({db.getCollectionItems(selectedCollection.id).length})</h2>
                  ...
                  video && (
                    ...
                    >
                      ...
                      <div className="p-3 space-y-1">
                        ...
                        <p className="text-[11px] text-gray-400">{video.channel_name}</p>
                      </div>
                    </div>
                  )
                ))}
